...
function advancedFilter(username) {
    if (username) {
        document.querySelector('#advancedFilter').innerHTML = '<p>Additional filtering options: </p><div class="form-check form-check-inline mb-3"><input class="form-check-input" checked type="radio" name="solvedOptions" id="inlineRadio" value="null"><label class="form-check-label" for="inlineRadio1">none</label></div><div class="form-check form-check-inline"><input class="form-check-input" type="radio" name="solvedOptions" id="inlineRadio2" value="true"><label class="form-check-label" for="inlineRadio2">Filter out solved puzzles</label></div><div class="form-check form-check-inline"><input class="form-check-input" type="radio" name="solvedOptions" id="inlineRadio3" value="false"><label class="form-check-label" for="inlineRadio3">Filter out unsolved puzzles</label></div><div class="form-check form-check-inline"><input class="form-check-input" type="radio" name="solvedOptions" id="inlineRadio4" value="trueC"><label class="form-check-label" for="inlineRadio4">Filter out your puzzles</label></div><div class="form-check form-check-inline"><input class="form-check-input" type="radio" name="solvedOptions" id="inlineRadio5" value="falseC"><label class="form-check-label" for="inlineRadio5">Filter out puzzles created by others</label></div>';
    }
    else {
        document.querySelector('#advancedFilter').innerHTML = '<p>Additional filtering options: <span>(Only if you sign up!) </span></p><div class="form-check form-check-inline mb-3"><input disabled class="form-check-input" checked type="radio" name="solvedOptions" id="inlineRadio" value="null"><label class="form-check-label" for="inlineRadio1">none</label></div><div class="form-check form-check-inline"><input disabled class="form-check-input" type="radio" name="solvedOptions" id="inlineRadio2" value="true"><label class="form-check-label" for="inlineRadio2">Filter out solved puzzles</label></div><div class="form-check form-check-inline"><input disabled class="form-check-input" type="radio" name="solvedOptions" id="inlineRadio3" value="false"><label class="form-check-label" for="inlineRadio3">Filter out unsolved puzzles</label></div><div class="form-check form-check-inline"><input disabled class="form-check-input" type="radio" name="solvedOptions" id="inlineRadio4" value="trueC"><label class="form-check-label" for="inlineRadio4">Filter out your puzzles</label></div><div class="form-check form-check-inline"><input disabled class="form-check-input" type="radio" name="solvedOptions" id="inlineRadio5" value="falseC"><label class="form-check-label" for="inlineRadio5">Filter out puzzles created by others</label></div>';
    }
}
