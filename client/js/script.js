...
function setPosition (window) {
    if (document.querySelector('#setBtn').innerHTML === '<button onclick="setPosition(window)">Set Initial Puzzle Position</button>') {
        ...
        document.querySelector('#success').innerHTML = '<label for="title">How would you like to name this puzzle? <span>(not required)</span></label><br><input class="mb-3" type="text" name="title" size="50" id="title">';
        document.querySelector('#success').innerHTML += '&nbsp;<br><label for="rating">How would you rate this puzzle? <span>(required)</span></label><br class=".d-block .d-sm-none"> <input maxlength="4" class="mb-3" type="text" name="rating" size="4" id="rating">';
